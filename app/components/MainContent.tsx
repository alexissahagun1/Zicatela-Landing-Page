    ...
    <section className="bg-white py-8 md:py-16 px-4 md:px-8">
      <div className="max-w-[755px] mx-auto">
        ...
        <div className="w-full md:w-[666px] md:h-[116px] mx-auto">
          <p className="text-[14px] md:text-[16px] leading-[16px] md:leading-[18px] text-[#4C86A0] text-center mb-3 md:mb-4">
            DONDE EL DISEÑO SE FUNDE CON LA NATURALEZA EN EL CORAZÓN DE LA PUNTA
          </p>
          <p className="text-[14px] md:text-[16px] leading-[16px] md:leading-[18px] text-[#222222] text-center mb-2">
            Dos espléndidas casas duplex de estilo brutalista.
          </p>
          <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-8">
            <span className="text-[14px] md:text-[16px] leading-[16px] md:leading-[18px] text-[#222222]">
              ● Casa Campeche
            </span>
            <span className="text-[14px] md:text-[16px] leading-[16px] md:leading-[18px] text-[#222222]">
              ▲ Casa Palmas
        ...
        <div className="w-full mx-auto flex items-end">
          <p className="text-[13px] md:text-[15px] leading-[15px] md:leading-[17px] text-[#222222] text-left md:text-justify">
