...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[var(--page-bg)]">
      <div className="relative mx-auto flex min-h-[372px] w-full max-w-[1280px] flex-col overflow-hidden px-6 pb-10 pt-4 text-black md:block md:h-[372px] md:min-h-0 md:px-0 md:pb-0 md:pt-0">
        ...
        <div className="mt-10 font-[family-name:var(--font-courier)] text-[13px] leading-5 text-black md:absolute md:left-[78.5%] md:top-[111px] md:mt-0">
          <Link href="/faq" className="hover:opacity-70">FAQs</Link>
        </div>

        <div className="mt-6 font-[family-name:var(--font-courier)] text-[13px] leading-5 text-black md:absolute md:left-[78.5%] md:top-[192px] md:mt-0">
